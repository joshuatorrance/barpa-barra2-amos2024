"""
# temporary copy of loaddata for tutorial development as BARPA-R projections data is still in staging
...
def list_experiments(model):
    ...
    if model == 'BARRA2':
        ...
        rootdir = "/g/data/py18/admin/staging/BARPA/output/CMIP6/DD/{domain}/BOM/{gcm}/{scenario}/{ens}/{rcm}"
        expts = glob("/g/data/py18/admin/staging/BARPA/output/CMIP6/DD/*/BOM/*/*/*/*")
...
def make_barpa_dirpath(rcm, gcm, scenario, freq):
    ...
    basepath = '/g/data/py18/admin/staging/BARPA/output'
...
def load_barpa_data(rcm, gcm, scenario, freq, variable, 
    ...
    ds = xr.open_mfdataset(files, chunks = {}, combine='nested', concat_dim='time', parallel=True, coords='minimal', data_vars='minimal', compat='override')
